...
export default function PageLoader() {
  ...
  return (
    <div 
      ref={overlayRef}
      className="fixed inset-0 z-[99999] bg-[#f8fafc] flex flex-col items-center justify-center pointer-events-auto"
      style={{ clipPath: "circle(150% at 50% 50%)" }} // Visible by default during SSR to prevent FOUC
    >
      <div className="relative overflow-hidden mb-12">
        <h1 className="text-4xl md:text-6xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-[#00629b] via-[#0077b6] to-[#06b6d4]">
          IEEE CIS CUSB
        </h1>
      </div>
      ...
      <div className="flex flex-col items-center w-full max-w-xs md:max-w-md">
        <div className="w-full h-[2px] bg-slate-200 rounded-full overflow-hidden relative">
          <div 
            ref={progressRef}
            className="absolute top-0 left-0 h-full bg-primary shadow-[0_0_15px_rgba(0,98,155,0.35)]"
            style={{ width: "0%" }}
          />
        </div>
      </div>
